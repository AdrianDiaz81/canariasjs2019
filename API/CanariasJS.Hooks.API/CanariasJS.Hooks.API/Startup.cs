...
namespace CanariasJS.Hooks.API
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddSingleton<IAvengerDomain, AvengerDomain>();
            services.AddSingleton<IAvengerRepository, AvengerRepository>();
            services.AddSingleton<AvengerDbContext>()
                .AsSelf();
